...
;NAME DEFINITIONS FOR GLOBAL VARIABLES ALLOCATED TO REGISTERS
	.DEF _secondsLeft=R4
	.DEF _secondsLeft_msb=R5
	.DEF _secondToCount=R6
	.DEF _secondToCount_msb=R7
	.DEF __lcd_x=R9
	.DEF __lcd_y=R8
	.DEF __lcd_maxx=R11
...
_0x0:
	.DB  0x25,0x64,0x2F,0x25,0x64,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 006A ICR1L=0x00;
	OUT  0x26,R30
; 0000 006B OCR1AH=0x7A;
	LDI  R30,LOW(122)
	OUT  0x2B,R30
; 0000 006C OCR1AL=0x11;
	LDI  R30,LOW(17)
	OUT  0x2A,R30
...
; 0000 00A4 // RS - PORTA Bit 0
; 0000 00A5 // RD - PORTA Bit 1
; 0000 00A6 // EN - PORTA Bit 2
; 0000 00A7 // D4 - PORTA Bit 3
; 0000 00A8 // D5 - PORTA Bit 4
; 0000 00A9 // D6 - PORTA Bit 5
; 0000 00AA // D7 - PORTA Bit 6
...
; 0000 00AF #asm("sei")
	sei
; 0000 00B0  secondsLeft = secondToCount;
	MOVW R4,R6
; 0000 00B1  PORTB = 0x21;
	LDI  R30,LOW(33)
	OUT  0x18,R30
; 0000 00B2 while (1)
_0x4:
; 0000 00B3       {
; 0000 00B4       if(TCNT1 == 31249)     {
	IN   R30,0x2C
	IN   R31,0x2C+1
	CPI  R30,LOW(0x7A11)
	LDI  R26,HIGH(0x7A11)
...
; 0000 00B5       lcd_gotoxy(0,0);
	...
	LDI  R26,LOW(0)
	CALL _lcd_gotoxy
; 0000 00B6            secondsLeft--;
	MOVW R30,R4
	SBIW R30,1
	MOVW R4,R30
; 0000 00B7            sprintf(lcdoutput,"%d/%d",secondsLeft,secondToCount);
	LDI  R30,LOW(_lcdoutput)
	LDI  R31,HIGH(_lcdoutput)
	ST   -Y,R31
	ST   -Y,R30
	__POINTW1FN _0x0,0
	ST   -Y,R31
	...
	CALL _sprintf
	ADIW R28,12
; 0000 00B8        lcd_puts(lcdoutput);
	LDI  R26,LOW(_lcdoutput)
	LDI  R27,HIGH(_lcdoutput)
	CALL _lcd_puts
; 0000 00B9       // delay_ms(1000);
; 0000 00BA        //lcd_clear();
; 0000 00BB       // Place your code here
; 0000 00BC                               }
; 0000 00BD      if(secondsLeft == 0){
_0x7:
	MOV  R0,R4
	OR   R0,R5
	BRNE _0x8
; 0000 00BE          if(PORTB.0 == 1){
	SBIS 0x18,0
	RJMP _0x9
; 0000 00BF          PORTB.5 = 0;
	CBI  0x18,5
...
; 0000 00CE 
; 0000 00CF          }
; 0000 00D0      secondsLeft = secondToCount;
_0x17:
_0x16:
	MOVW R4,R6
; 0000 00D1      }
